...
def spare_part_supply_post_save(sender, instance, **kwargs):
    if instance.count_supply > 0:
        ...
        if part.exists():
            ...
            logger.info('New Supply spare part. Updated amount for spare_part_id %s', instance.spare_part)
        else:
            ...
            logger.info('New Supply spare part. Created new amount for spare part %s', instance.spare_part)
...
def spare_part_shipment_post_save(sender, instance, **kwargs):
