...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.BooleanField(
                        blank=True,
                        db_comment="true если коммент был создано на стороне django, если пользователем - false",
                        default=False,
                    ),
                ),
            ],
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["article"], name="spare_part_article_187345_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="sparepart",
        ...
        migrations.AddIndex(
            model_name="sparepartcount",
            index=models.Index(
                fields=["spare_part"], name="spare_part__spare_p_5cafe6_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="sparepartsupply",
            index=models.Index(
                fields=["spare_part"], name="spare_part__spare_p_0ac348_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="sparepartsupply",
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                to="spare_part.sparepartshipmentv2",
            ),
        ),
        migrations.AddField(
            model_name="sparepartshipmentm2m",
        ...
        migrations.AddIndex(
            model_name="sparepartshipmentv2",
            index=models.Index(
                fields=["service"], name="spare_part__service_f4d148_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="sparepartshipmentv2",
        ...
        migrations.AddIndex(
            model_name="sparepartshipmentm2m",
            index=models.Index(
                fields=["spare_part"], name="spare_part__spare_p_3294a9_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="sparepartshipmentm2m",
            index=models.Index(
                fields=["shipment"], name="spare_part__shipmen_919665_idx"
            ),
        ),
    ]
