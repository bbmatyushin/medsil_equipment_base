...
class Equipment(EbaseModel):
    ...
    manufacturer = models.ForeignKey(
        "directory.Manufacturer", on_delete=models.SET_NULL, null=True, blank=False,
    ...
    supplier = models.ForeignKey(
        "directory.Supplier", on_delete=models.SET_NULL, null=True, blank=True,
...
class EquipmentAccDepartment(EbaseModel):
    ...
    department = models.ForeignKey(
        'clients.Department', on_delete=models.RESTRICT, null=False, editable=True,
